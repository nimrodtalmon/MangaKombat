...
Usage:
    python3 tools/generate-dummy-sprites.py
"""

from PIL import Image, ImageDraw
import os

W, H = 200, 270   # image dimensions

# ── Helpers ──────────────────────────────────────────────────────────────────
def seg(d, a, b, w, fill):
    """Thick rounded segment."""
...
ATTACK = dict(
    ...
    r_shoulder=(129,80), r_elbow=(156,84),  r_hand=(182,76),   # punch extended right
